...
class Produto
{
    ...
    {
        // Database.php já foi carregado antes
    ...
    /**
     * Retorna todos os produtos vinculados à empresa-usuário,
     * usando o campo produtos.empresa_cnpj.
     *
     * @param string $empresaCnpj
     * @return array
     */
    public function getAllApp(string $empresaCnpj): array
    {
