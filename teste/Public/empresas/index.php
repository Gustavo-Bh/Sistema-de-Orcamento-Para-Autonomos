...
<body>
        ...
        <table class="table" id="emp-table">
          <thead>
            <tr>
              ...
              <th style="width: 120px;" class="d-none d-lg-table-cell">Telefone</th>
              <th style="width: 140px;" class="d-none d-lg-table-cell">CPF/CNPJ</th>
  ...
  <script>
    ...
    const fields = [
      ...
      'ultimo_numero_nfe','certificado','senha','ambiente','cidade_id'
    ];
    ...
    async function editEmpresa(id) {
      ...
      fields.forEach(f => form[f].value = e[f] ?? '');
